        ...
        <div className="glass-card p-6 rounded-2xl mb-8 transition-all duration-300">
            ...
            <div className={`grid grid-cols-1 md:grid-cols-12 gap-4 items-end transition-all duration-300 overflow-hidden ${isExpanded ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'}`}>
                ...
                <div className="grid grid-cols-2 gap-4 md:col-span-6">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full bg-slate-950/50 border border-slate-700 rounded-xl px-3 py-2.5 text-slate-100 focus:outline-none focus:ring-2 focus:ring-orange-500/50 focus:border-orange-500 transition-all [color-scheme:dark]"
                        />
                    </div>
                    <div>
                ...
                <div className="md:col-span-3">
                    <button
                        onClick={onSearch}
                        className="w-full bg-gradient-to-r from-orange-600 to-amber-600 text-white px-6 py-2.5 rounded-xl hover:from-orange-500 hover:to-amber-500 transition-all shadow-lg shadow-orange-500/30 font-medium flex items-center justify-center gap-2 active:scale-95 transform duration-100 border border-white/10"
                    >
                        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
